...
//
//    Mat src = imread("C:\\Users\\Administrator\\Desktop\\d\\1\\x0.jpg");
//    if (!src.data) {
...
//            pyrDown(cur, dst, Size(cur.cols/3, cur.rows/3));
...
//            cur = dst;
//			temp = IplImage(dst);
//			sprintf(name,"C:\\Users\\Administrator\\Desktop\\d\\1\\x\\%d%d.jpg" ,i,i);
//			bb=name;
//
//			cvSaveImage(bb,&temp);
//			i++;
